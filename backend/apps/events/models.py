...
class Event(models.Model):
    ...
    ppt_link               = models.URLField(
                                ...
                                null=True,
                                blank=True,
                                help_text='Google Drive link for the event PPT/Slides')
    youtube_link           = models.URLField(
                                max_length=500,
                                null=True,
                                blank=True,
                                help_text='YouTube link for the event recording')
    other_material_link    = models.URLField(
                                max_length=500,
                                null=True,
                                blank=True,
                                help_text='Google Drive link for PDFs, Zip files, or other resources')
